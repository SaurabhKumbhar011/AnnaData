...
<body>
<header>
        <div class="logo">Anna<b style="color: #ECA72C;">Data</b></div>
        <div class="hamburger">
            <div class="line"></div>
            <div class="line"></div>
            <div class="line"></div>
...
<!--             
            ...
            <br> -->
              ...
              <a href="logout.php" style="float: left;margin: 18px ;border-radius:5px; background-color: #d18e11; color: white;padding: ;padding-left: 10px;padding-right: 10px;">Logout</a>
              </div>
              <br>
              <br>
